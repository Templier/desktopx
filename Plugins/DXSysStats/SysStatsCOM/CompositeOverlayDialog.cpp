...
CompositeOverlayDialog::CompositeOverlayDialog(ICompositeOverlay *overlay, IObserver *observer, WORD idd) :
...
LRESULT CompositeOverlayDialog::x(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
...
LRESULT CompositeOverlayDialog::y(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
	BOOL iRet = TRUE;	// For GetDlgItemInt
	int i = GetDlgItemInt(wID, &iRet, TRUE);
...
LRESULT CompositeOverlayDialog::xRot(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
	BOOL iRet = TRUE;	// For GetDlgItemInt
	int i = GetDlgItemInt(wID, &iRet, TRUE);
...
LRESULT CompositeOverlayDialog::yRot(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
	BOOL iRet = TRUE;	// For GetDlgItemInt
	int i = GetDlgItemInt(wID, &iRet, TRUE);
...
LRESULT CompositeOverlayDialog::rotation(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
	BOOL iRet = TRUE;	// For GetDlgItemInt
	int i = GetDlgItemInt(wID, &iRet, TRUE);
...
LRESULT CompositeOverlayDialog::hScale(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
	double scale = 1.0L;
	char val[64];
...
LRESULT CompositeOverlayDialog::vScale(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
	double scale = 1.0L;
	char val[64];
	GetDlgItemText(wID, val, sizeof(val));
...
LRESULT CompositeOverlayDialog::mode(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
...
LRESULT CompositeOverlayDialog::setOverlay(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
	ISimpleOverlay2 *pISO2 = 0;
	HRESULT hr = overlay->QueryInterface(__uuidof(ISimpleOverlay2), (void **)&pISO2);
	if (SUCCEEDED(hr))
...
void CompositeOverlayDialog::resetOverlayList()
{
	ISimpleOverlay2 *pISO2 = 0;
	HRESULT hr = overlay->QueryInterface(__uuidof(ISimpleOverlay2), (void **)&pISO2);
	if (FAILED(hr))
...
HTREEITEM CompositeOverlayDialog::drawOverlayList(ICompositeOverlay *coll, HTREEITEM parent, const IOverlay *selected, TVINSERTSTRUCT &itvIns)
{
 ...
 */
LRESULT CompositeOverlayDialog::OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
